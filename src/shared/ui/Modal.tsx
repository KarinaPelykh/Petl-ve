  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content
        ...
        className={clsx(
          "tablet-l:w-118.25 tablet-l:px-18 rounded-ms fixed top-1/2 left-1/2 flex w-83.75 -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center gap-5 bg-white p-10",
          className,
        )}
      >
