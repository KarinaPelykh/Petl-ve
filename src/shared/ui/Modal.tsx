  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content
        ...
        className="tablet-l:w-[473px] tablet-l:px-[72px] rounded-ms fixed top-1/2 left-1/2 flex w-[335px] -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center gap-5 bg-white p-10"
      >
